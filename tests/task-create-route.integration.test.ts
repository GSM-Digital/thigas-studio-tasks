...
describe("POST /api/tasks", () => {
  ...
  it("persiste a data e hora do prazo junto com a tarefa", async () => {
    ...
    mocks.classifyTask.mockResolvedValue({ complexityLevel: 2, basePoints: 8, efficiencyAdjustment: 0, finalPoints: 8, rationale: "Setup moderado.", model: "gemini-3.8-flash" });
