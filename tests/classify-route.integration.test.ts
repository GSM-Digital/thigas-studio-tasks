...
describe("POST /api/classify", () => {
  ...
  it("valida, classifica e responde com o contrato público", async () => {
    mocks.classifyTask.mockResolvedValue({ complexityLevel: 3, basePoints: 25, efficiencyAdjustment: 8, finalPoints: 33, rationale: "Implementação com integrações entregue com eficiência.", model: "gpt-5.4-nano" });
